...
public class FitnessSyncAdapter extends RecyclerView.Adapter<FitnessSyncAdapter.FitnessSyncViewHolder> {

    Context context;
    ArrayList<Fitness> fitnessArrayList;
    CustomItemClickListener customItemClickListener;


    public FitnessSyncAdapter(Context context, ArrayList<Fitness> bloodSugarArrayList) {
        this.context = context;
        this.fitnessArrayList = bloodSugarArrayList;
    }

    @Override
    public FitnessSyncViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());
        View itemView = layoutInflater.inflate(R.layout.item_bsm_sync_data, parent, false);
        return new FitnessSyncViewHolder(itemView);

    }

    @Override
    public void onBindViewHolder(FitnessSyncViewHolder holder, int position) {

        int bsType;

        bsType = Integer.valueOf(fitnessArrayList.get(position).getType());
        ...
        holder.valueText.setText(fitnessArrayList.get(position).getDistance());
        holder.dateTextValue.setText(fitnessArrayList.get(position).getTimestamp());
    ...
    public class FitnessSyncViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
...
//    TextView dateText, dateTextValue;
        ...
        public FitnessSyncViewHolder(View itemView) {
            super(itemView);

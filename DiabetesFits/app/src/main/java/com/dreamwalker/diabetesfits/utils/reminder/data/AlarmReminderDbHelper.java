package com.dreamwalker.diabetesfits.utils.reminder.data;
...
public class AlarmReminderDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String SQL_CREATE_ALARM_TABLE =  "CREATE TABLE IF NOT EXISTS " + AlarmReminderContract.AlarmReminderEntry.TABLE_NAME + " ("

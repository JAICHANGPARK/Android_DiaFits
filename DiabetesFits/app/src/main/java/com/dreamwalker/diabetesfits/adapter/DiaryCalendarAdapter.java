...
public class DiaryCalendarAdapter extends RecyclerView.Adapter<DiaryCalendarAdapter.ViewHolder> {
    ...
    public DiaryCalendarAdapter(Context context) {
    ...
    @Override
    public DiaryCalendarAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(layoutInflater.inflate(R.layout.item_diary, parent, false));
    }

package com.dreamwalker.verticalintrov2;
    ...
    static void setUpRecentAppStyle(Activity activity, int targetColor) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            try {
                ...
                ActivityManager.TaskDescription taskDescription = new ActivityManager.TaskDescription(activity.getString(R.string.app_name), bm, recentAppsStyleColor);

package com.dreamwalker.receiptview;
...
public class ReceiptView extends FrameLayout {
    ...
    @RequiresApi(api = 21)
    public ReceiptView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        paintZigzag.setStyle(Paint.Style.FILL);
